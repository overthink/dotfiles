...
" Mark addition for jekyll and pygments
syn region markdownCodeBlock matchgroup=markdownCodeDelimiter start="{% highlight.*%}" end="{% endhighlight %}"
...
hi def link markdownCodeBlock             Delimiter
